...
const social = [
    {
        name: 'GitHub',
        icon: 'github',
        link: 'https://github.com/Luism2306',
    },
    {
        name: 'LinkedIn',
        icon: 'linkedin',
...
const home = {
    ...
    headline: <>Middle FrontEnd</>,
    subline: <>Yo soy Luis Miguel, soy un Middle FrontEnd, donde creo experiencias de usuario intuitivas. Después del horario laboral, creo mis propios proyectos.</>
}
